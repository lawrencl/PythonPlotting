...
file = '/Users/laml/Documents/Fall 2014/ESD.754 Data Mining/HW1/ToyotaCorolla.txt'
...
pd.tools.plotting.scatter_matrix(data2[['Price','Age_08_04','KM','HP','cc','Weight','Mfr_Guarantee']], alpha=0.2, diagonal='hist').show()
